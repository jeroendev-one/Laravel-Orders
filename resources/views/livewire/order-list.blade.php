...
<div class="mb-8 bg-red">
            <select name="date" wire:model="date" class="p-2 px-4 py-2 pr-8 leading-tight bg-blue border border-gray-400 rounded shadow appearance-none hover:border-gray-500 focus:outline-none focus:shadow-outline">
    ...
    <table class="min-w-full">
        ...
        <tbody class="bg-white">
            ...
            <tr>
                ...
                <td class="px-6 py-4 whitespace-no-wrap border-b text-blue-900 border-gray-500 text-sm leading-5">{{ $order->restaurant }}</td>
                <td class="px-6 py-4 whitespace-no-wrap border-b text-blue-900 border-gray-500 text-sm leading-5">{{ $order->bestelling }}</td>
                ...
                <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-500 text-blue-900 text-sm leading-5">{{ $order->datum }}</td>
